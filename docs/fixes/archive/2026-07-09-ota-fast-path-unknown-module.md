...
1. Native `registerSegmentWithId` 在同一 RN runtime 内 **不会重新 eval** 已加载的 segment（见 [2026-07-08-ota-register-feature-not-called.md](../2026-07-08-ota-register-feature-not-called.md)）
