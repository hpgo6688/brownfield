...
> **⚠️ 部分 superseded**  
> 文中 fast path（`tryReuseOtaFeature` 直接 setScreen）已废弃；`verifyOtaBundleBody` 与下载完整性仍有效。Re-entry 最终方案见：[docs/interview/ota-reentry-case-study.md](../interview/ota-reentry-case-study.md)
